...
const OurCourses = () => {
  return (
    <div className="max-w-full mx-4 md:mx-8 mb-12 bg-blue-200 rounded-tl-none rounded-br-none rounded-tr-[4rem] rounded-bl-[4rem] flex flex-col p-6 md:p-8">
      {/* Header Section */}
      ...
      <div className="flex flex-wrap justify-center gap-6 mt-8 mb-4">
        {/* Card 1 */}
        <div className="bg-white shadow-md rounded-tr-[2rem] rounded-bl-[2rem] p-4 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 2xl:w-[18%] text-center transition-colors duration-300 hover:bg-blue-200">
          <img
            src="/6MONTHS.png" // Replace with the correct image path for Card 1
            alt="6-Month Course"
            className="w-full h-52 object-cover rounded-tr-[2rem] rounded-bl-md"
          />
