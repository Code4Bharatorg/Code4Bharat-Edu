    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100 px-4">
      <div className="max-w-4xl w-full bg-white shadow-lg rounded-lg p-6 md:p-10">
        ...
        <div className="space-y-6 text-gray-700 text-lg">
          <p>
            Welcome to <strong>Education.Code4Bharat</strong>. By accessing or using our website 
            (<a href="https://education.code4bharat.com/" className="text-blue-500 hover:underline">
              www.education.code4bharat.com
