...
export default function PrivacyPolicy() {
  return (
    <div className="flex justify-center items-center min-h-screen px-4 mt-6 mb-6">
      <div className="max-w-4xl w-full bg-white shadow-lg rounded-lg p-6 md:p-10">
        ...
        <div className="space-y-6 text-gray-700 text-lg">
          <p>
            At <strong>Education.Code4Bharat</strong>, we are committed to safeguarding your privacy. This policy explains how we
          ...
          <p>
            ...
            <strong>Education.Code4Bharat</strong>, your privacy and trust are of utmost importance to us.
          </p>
        </div>
      </div>
    </div>
